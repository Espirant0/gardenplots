...
<div class="add_form">
	<form action="/add_year_contribution/" id="add-form" method="post">
		<div class="control">
			<div class="select">
				<select name="PERSON">
		...
		<div class="control">
			<input class="input" type="number" id="date" name="DATE" placeholder="Год" min="1950" max="<?= $currentDate->format('Y') ?>" required>
		</div>
		<div class="btn-inner">
